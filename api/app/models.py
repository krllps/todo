...
class User(Base):
    ...
    name = sqla.Column(sqla.String, nullable=False, unique=True, index=True)
    email = sqla.Column(sqla.String, default=None, unique=True, index=True)
...
class Task(Base):
    ...
    id = sqla.Column(sqla.Integer, primary_key=True)
    name = sqla.Column(sqla.String, nullable=False, index=True)
    description = sqla.Column(sqla.String, default=None)
    due = sqla.Column(sqla.DateTime, nullable=False, index=True)
    is_checked = sqla.Column(sqla.Boolean, default=False, index=True)
